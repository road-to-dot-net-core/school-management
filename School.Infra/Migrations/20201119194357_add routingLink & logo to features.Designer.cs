...
namespace School.Infra.Migrations
{
    ...
    [Migration("20201119194357_add routingLink & logo to features")]
    partial class addroutingLinklogotofeatures
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Schools.Domain.Models.Access_Control.Feature", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasDefaultValue(new DateTime(2020, 11, 19, 19, 43, 56, 267, DateTimeKind.Local).AddTicks(2295));
            ...
            modelBuilder.Entity("Schools.Domain.Models.Access_Control.Permission", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasColumnName("CreatedOn")
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 11, 19, 19, 43, 56, 321, DateTimeKind.Local).AddTicks(4048));
            ...
            modelBuilder.Entity("Schools.Domain.Models.Access_Control.RefreshToken", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasColumnName("CreatedOn")
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 11, 19, 19, 43, 56, 422, DateTimeKind.Local).AddTicks(4088));
            ...
            modelBuilder.Entity("Schools.Domain.Models.Access_Control.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasColumnName("CreatedOn")
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 11, 19, 19, 43, 56, 327, DateTimeKind.Local).AddTicks(3535));
            ...
            modelBuilder.Entity("Schools.Domain.Models.Access_Control.RolePermission", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasColumnName("CreatedOn")
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 11, 19, 19, 43, 56, 331, DateTimeKind.Local).AddTicks(6595));
            ...
            modelBuilder.Entity("Schools.Domain.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasColumnName("CreatedOn")
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 11, 19, 19, 43, 56, 336, DateTimeKind.Local).AddTicks(9145));
            ...
            modelBuilder.Entity("Schools.Domain.Models.Access_Control.Feature", b =>
                {
                    b.HasOne("Schools.Domain.Models.Access_Control.Feature", "ParentFeature")
                        .WithMany()
